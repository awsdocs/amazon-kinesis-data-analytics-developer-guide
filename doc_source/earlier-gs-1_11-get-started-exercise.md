# Step 3: Create and Run a Kinesis Data Analytics for Apache Flink Application<a name="earlier-gs-1_11-get-started-exercise"></a>
...
+ [Create and Run the Kinesis Data Analytics Application](#earlier-gs-1_11-get-started-exercise-7)
+ [Next Step](#earlier-gs-1_11-get-started-exercise-next-step-4)

## Create Two Amazon Kinesis Data Streams<a name="earlier-gs-1_11-get-started-exercise-1"></a>
...
## Write Sample Records to the Input Stream<a name="earlier-gs-1_11-get-started-exercise-2"></a>
...
## Download and Examine the Apache Flink Streaming Java Code<a name="earlier-gs-1_11-get-started-exercise-5"></a>
...
## Compile the Application Code<a name="earlier-gs-1_11-get-started-exercise-5.5"></a>
...
## Upload the Apache Flink Streaming Java Code<a name="earlier-gs-1_11-get-started-exercise-6"></a>
...
## Create and Run the Kinesis Data Analytics Application<a name="earlier-gs-1_11-get-started-exercise-7"></a>
...
### Create and Run the Application \(Console\)<a name="earlier-gs-1_11-get-started-exercise-7-console"></a>

Follow these steps to create, configure, update, and run the application using the console\.

#### Create the Application<a name="earlier-gs-1_11-get-started-exercise-7-console-create"></a>
...
#### Edit the IAM Policy<a name="earlier-gs-1_11-get-started-exercise-7-console-iam"></a>
...
#### Configure the Application<a name="earlier-gs-1_11-get-started-exercise-7-console-configure"></a>
...
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/kinesisanalytics/latest/java/earlier-gs-1_11-get-started-exercise.html)
...
#### Run the Application<a name="earlier-gs-1_11-get-started-exercise-7-console-run"></a>
...
#### Stop the Application<a name="earlier-gs-1_11-get-started-exercise-7-console-stop"></a>

On the **MyApplication** page, choose **Stop**\. Confirm the action\.

#### Update the Application<a name="earlier-gs-1_11-get-started-exercise-7-console-update"></a>
...
#### Create an IAM Role<a name="earlier-gs-1_11-get-started-exercise-7-cli-role"></a>
...
**Note**  
For this exercise, Kinesis Data Analytics assumes this role for both reading data from a Kinesis data stream \(source\) and writing output to another Kinesis data stream\. So you attach the policy that you created in the previous step, [Create a Permissions Policy](#earlier-gs-1_11-get-started-exercise-7-cli-policy)\.
...
#### Create the Kinesis Data Analytics Application<a name="earlier-gs-1_11-get-started-exercise-7-cli-create"></a>
...
#### Start the Application<a name="earlier-gs-1_11-get-started-exercise-7-cli-start"></a>
...
#### Stop the Application<a name="earlier-gs-1_11-get-started-exercise-7-cli-stop"></a>
...
#### Add a CloudWatch Logging Option<a name="earlier-gs-1_11-get-started-exercise-7-cli-cw"></a>
...
#### Update Environment Properties<a name="earlier-gs-1_11-get-started-exercise-7-cli-update-env"></a>
...
#### Update the Application Code<a name="earlier-gs-1_11-get-started-exercise-7-cli-update-code"></a>
...
## Next Step<a name="earlier-gs-1_11-get-started-exercise-next-step-4"></a>
