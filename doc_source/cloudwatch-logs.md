...
For more information about using an IAM role for Kinesis Data Analytics, see [Identity and Access Management for Amazon Kinesis Data Analytics](security-iam.md)\.
