# Identity and Access Management for Amazon Kinesis Data Analytics<a name="security-iam"></a>





AWS Identity and Access Management \(IAM\) is an AWS service that helps an administrator securely control access to AWS resources\. IAM administrators control who can be *authenticated* \(signed in\) and *authorized* \(have permissions\) to use Kinesis Data Analytics resources\. IAM is an AWS service that you can use with no additional charge\.

**Topics**
+ [Audience](#security_iam_audience)
+ [Authenticating with identities](#security_iam_authentication)
+ [Managing access using policies](#security_iam_access-manage)
+ [How Amazon Kinesis Data Analytics works with IAM](security_iam_service-with-iam.md)
+ [Identity\-based policy examples for Amazon Kinesis Data Analytics](security_iam_id-based-policy-examples.md)
+ [Troubleshooting Amazon Kinesis Data Analytics identity and access](security_iam_troubleshoot.md)

## Audience<a name="security_iam_audience"></a>

How you use AWS Identity and Access Management \(IAM\) differs, depending on the work that you do in Kinesis Data Analytics\.

**Service user** – If you use the Kinesis Data Analytics service to do your job, then your administrator provides you with the credentials and permissions that you need\. As you use more Kinesis Data Analytics features to do your work, you might need additional permissions\. Understanding how access is managed can help you request the right permissions from your administrator\. If you cannot access a feature in Kinesis Data Analytics, see [Troubleshooting Amazon Kinesis Data Analytics identity and access](security_iam_troubleshoot.md)\.

**Service administrator** – If you're in charge of Kinesis Data Analytics resources at your company, you probably have full access to Kinesis Data Analytics\. It's your job to determine which Kinesis Data Analytics features and resources your service users should access\. You must then submit requests to your IAM administrator to change the permissions of your service users\. Review the information on this page to understand the basic concepts of IAM\. To learn more about how your company can use IAM with Kinesis Data Analytics, see [How Amazon Kinesis Data Analytics works with IAM](security_iam_service-with-iam.md)\.

**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to Kinesis Data Analytics\. To view example Kinesis Data Analytics identity\-based policies that you can use in IAM, see [Identity\-based policy examples for Amazon Kinesis Data Analytics](security_iam_id-based-policy-examples.md)\.
