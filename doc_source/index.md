...
+ [Kinesis Data Analytics for Apache Flink: How It Works](how-it-works.md)
   ...
   + [Using CloudFormation with Kinesis Data Analytics](lambda-cfn-flink.md)
   + [Using the Apache Flink Dashboard with Amazon Kinesis Data Analytics](how-dashboard.md)
+ [Release versions](release-versions.md)
   + [Amazon Kinesis Data Analytics for Apache Flink 1.15.2 release](flink-1-15-2.md)
...
+ [Getting Started (Scala)](examples-gs-scala.md)
...
+ [Training Workshops, Labs, and Solution Implementations](examples-solutions.md)
...
+ [Best Practices for a Kinesis Data Analytics for Apache Flink](best-practices.md)
+ [Apache Flink Stateful Functions](stateful-functions.md)
