...
+ [Amazon Kinesis Data Analytics: How It Works](how-it-works.md)
   + [Configuring Application Input](how-it-works-input.md)
      ...
      + [Using the Lambda Preprocessing Feature](lambda-preprocessing.md)
...
+ [Example Amazon Kinesis Data Analytics Applications](example-apps.md)
   + [Examples: Preprocessing Streams](apps-preprocess-stream.md)
      + [Example: Manipulating Strings and Date Times](app-string-datetime-manipulation.md)
         + [Example: String Manipulation (W3C_LOG_PARSE Function)](string-manipulation-example-1.md)
         + [Example: String Manipulation (VARIABLE_COLUMN_LOG_PARSE Function)](string-manipulation-example-2.md)
   ...
   + [Examples: Basic Analytics](apps-basic-analytics.md)
      + [Example: Most Frequently Occurring Values (the TOP_K_ITEMS_TUMBLING Function)](top-k-example.md)
      + [Example: Counting Distinct Values (the COUNT_DISTINCT_ITEMS_TUMBLING function)](count-distinct-items-example.md)
   ...
   + [Examples: Advanced Analytics](apps-adv-analytics.md)
      + [Example: Detecting Data Anomalies on a Stream (the RANDOM_CUT_FOREST Function)](app-anomaly-detection.md)
