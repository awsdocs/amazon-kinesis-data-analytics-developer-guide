# Step 3: Create and Run a Kinesis Data Analytics for Apache Flink Application<a name="get-started-exercise-1-13"></a>
...
+ [Create and Run the Kinesis Data Analytics Application](#get-started-exercise-7-1-13)
+ [Next Step](#get-started-exercise-next-step-4-1-13)

## Create Two Amazon Kinesis Data Streams<a name="get-started-exercise-1-1-13"></a>
...
## Write Sample Records to the Input Stream<a name="get-started-exercise-2-1-13"></a>
...
## Download and Examine the Apache Flink Streaming Java Code<a name="get-started-exercise-5-1-13"></a>
...
## Compile the Application Code<a name="get-started-exercise-5.5-1-13"></a>
...
## Upload the Apache Flink Streaming Java Code<a name="get-started-exercise-6-1-13"></a>
...
## Create and Run the Kinesis Data Analytics Application<a name="get-started-exercise-7-1-13"></a>
...
### Create and Run the Application \(Console\)<a name="get-started-exercise-7-console-1-13"></a>

Follow these steps to create, configure, update, and run the application using the console\.

#### Create the Application<a name="get-started-exercise-7-console-create-1-13"></a>
...
#### Edit the IAM Policy<a name="get-started-exercise-7-console-iam-1-13"></a>
...
#### Configure the Application<a name="get-started-exercise-7-console-configure-1-13"></a>
...
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/kinesisanalytics/latest/java/get-started-exercise-1-13.html)
...
#### Run the Application<a name="get-started-exercise-7-console-run-1-13"></a>
...
#### Stop the Application<a name="get-started-exercise-7-console-stop-1-13"></a>

On the **MyApplication** page, choose **Stop**\. Confirm the action\.

#### Update the Application<a name="get-started-exercise-7-console-update-1-13"></a>
...
### Create and Run the Application \(AWS CLI\)<a name="get-started-exercise-7-cli-1-13"></a>
...
#### Create a Permissions Policy<a name="get-started-exercise-7-cli-policy-1-13"></a>
...
#### Create an IAM Role<a name="get-started-exercise-7-cli-role-1-13"></a>
...
**Note**  
For this exercise, Kinesis Data Analytics assumes this role for both reading data from a Kinesis data stream \(source\) and writing output to another Kinesis data stream\. So you attach the policy that you created in the previous step, [Create a Permissions Policy](#get-started-exercise-7-cli-policy-1-13)\.
...
#### Create the Kinesis Data Analytics Application<a name="get-started-exercise-7-cli-create-1-13"></a>
...
#### Start the Application<a name="get-started-exercise-7-cli-start-1-13"></a>
...
#### Stop the Application<a name="get-started-exercise-7-cli-stop-1-13"></a>
...
#### Add a CloudWatch Logging Option<a name="get-started-exercise-7-cli-cw-1-13"></a>
...
#### Update Environment Properties<a name="get-started-exercise-7-cli-update-env-1-13"></a>
...
#### Update the Application Code<a name="get-started-exercise-7-cli-update-code-1-13"></a>
...
## Next Step<a name="get-started-exercise-next-step-4-1-13"></a>
