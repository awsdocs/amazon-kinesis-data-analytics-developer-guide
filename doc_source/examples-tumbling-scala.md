# Example: Creating a Tumbling Window in Scala<a name="examples-tumbling-scala"></a>
...
### Delete Your Kinesis Data Analytics Application<a name="examples-tumbling-scala-cleanup-app"></a>
