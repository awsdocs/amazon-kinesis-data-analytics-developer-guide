# Example: Creating a Sliding Window in Scala<a name="examples-sliding-scala"></a>
...
### Delete Your Kinesis Data Analytics Application<a name="examples-sliding-scala-cleanup-app"></a>
