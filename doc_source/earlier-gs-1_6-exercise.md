# Step 3: Create and Run a Kinesis Data Analytics application<a name="earlier-gs-1_6-exercise"></a>
...
+ [Create and Run the Kinesis Data Analytics Application](#earlier-gs-1_6-exercise-7)

## Create Two Amazon Kinesis Data Streams<a name="earlier-gs-1_6-exercise-1"></a>
...
## Write Sample Records to the Input Stream<a name="earlier-gs-1_6-exercise-2"></a>
...
## Download and Examine the Apache Flink Streaming Java Code<a name="earlier-gs-1_6-exercise-5"></a>
...
## Compile the Application Code<a name="earlier-gs-1_6-exercise-5.5"></a>

In this section, you use the Apache Maven compiler to create the Java code for the application\. For information about installing Apache Maven and the Java Development Kit \(JDK\), see [Prerequisites for Completing the Exercises](earlier-gs-1_6.md#su-1_6-prerequisites)\.
...
1. To use your application code, you compile and package it into a JAR file\. You can compile and package your code in one of two ways:
   + Use the command\-line Maven tool\. Create your JAR file by running the following command in the directory that contains the `pom.xml` file:
     ...
     ```
**Note**  
The \-Dflink\.version parameter is not required for Kinesis Data Analytics Runtime version 1\.0\.1; it is only required for version 1\.1\.0 and later\. For more information, see [Specifying your Application's Apache Flink Version](how-creating-apps.md#how-creating-apps-building-flink)\.
...
## Upload the Apache Flink Streaming Java Code<a name="earlier-gs-1_6-exercise-6"></a>
...
## Create and Run the Kinesis Data Analytics Application<a name="earlier-gs-1_6-exercise-7"></a>
...
### Create and Run the Application \(Console\)<a name="earlier-gs-1_6-exercise-7-console"></a>

Follow these steps to create, configure, update, and run the application using the console\.

#### Create the Application<a name="earlier-gs-1_6-exercise-7-console-create"></a>
...
#### Edit the IAM Policy<a name="earlier-gs-1_6-exercise-7-console-iam"></a>
...
#### Configure the Application<a name="earlier-gs-1_6-exercise-7-console-configure"></a>
...
#### Run the Application<a name="earlier-gs-1_6-exercise-7-console-run"></a>
...
#### Stop the Application<a name="earlier-gs-1_6-exercise-7-console-stop"></a>

On the **MyApplication** page, choose **Stop**\. Confirm the action\.

#### Update the Application<a name="earlier-gs-1_6-exercise-7-console-update"></a>
...
### Create and Run the Application \(AWS CLI\)<a name="earlier-gs-1_6-exercise-7-cli"></a>
...
#### Create a Permissions Policy<a name="earlier-gs-1_6-exercise-7-cli-policy"></a>
...
#### Create an IAM Role<a name="earlier-gs-1_6-exercise-7-cli-role"></a>
...
**Note**  
For this exercise, Kinesis Data Analytics assumes this role for both reading data from a Kinesis data stream \(source\) and writing output to another Kinesis data stream\. So you attach the policy that you created in the previous step, [Create a Permissions Policy](#earlier-gs-1_6-exercise-7-cli-policy)\.
...
#### Create the Kinesis Data Analytics Application<a name="earlier-gs-1_6-exercise-7-cli-create"></a>
...
#### Start the Application<a name="earlier-gs-1_6-exercise-7-cli-start"></a>
...
#### Stop the Application<a name="earlier-gs-1_6-exercise-7-cli-stop"></a>
...
#### Add a CloudWatch Logging Option<a name="earlier-gs-1_6-exercise-7-cli-cw"></a>
...
#### Update Environment Properties<a name="earlier-gs-1_6-exercise-7-cli-update-env"></a>
...
#### Update the Application Code<a name="earlier-gs-1_6-exercise-7-cli-update-code"></a>
